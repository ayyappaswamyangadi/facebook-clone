...
A full-stack Facebook clone — a monorepo with a React frontend, Express REST API, and a dedicated Socket.io server for real-time features.
...
├── server/          ← Node.js / Express REST API  (port 5757)
└── socket/          ← Socket.io real-time server  (port 8900)
```
...
- **Create Posts** — text + image, auto-uploaded to the server
- **Timeline Feed** — posts from yourself and everyone you follow
- **Like / Unlike** posts with live count updates
- **Comments** — add, delete, and like individual comments
- **Delete Post** — post owner can remove their own posts

### Profile
- Cover photo + profile picture
- Bio, city, hometown, relationship status
- **Edit Profile** — update all fields including photos
...
### Notifications
- Notification badge in the topbar (polls every 30 s)
- Dropdown listing recent notifications
- Types: like, comment, follow, message
- Auto-marked as read when the dropdown is opened

### Search
- Live user search from the topbar
- Debounced API calls (300 ms)
- Results link directly to user profiles

### Social
- Follow / Unfollow users
- **Friend suggestions** — people you don't follow yet
- Online-user tracking via socket
- Sidebar shows your following list
...
| Styling   | SCSS (custom Facebook-like theme)    |
...
| GET    | `/users/friends/:userId`      | Following list        |
